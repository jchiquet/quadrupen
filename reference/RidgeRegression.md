...
- [`RidgeRegression$new()`](#method-RidgeRegression-new)

- [`RidgeRegression$clone()`](#method-RidgeRegression-clone)
...
Initialize a `RidgeRegression` model

#### Usage

    RidgeRegression$new(data, intercept, regParam)
...
#### Usage
    ...
    RidgeRegression$clone(deep = FALSE)
