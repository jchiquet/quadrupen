...
- SCAD[^2] (Smoothly Clip Absolute Deviation) - _preliminary version_
- MCP[^3] (Minimax Concave Penalty) - _preliminary version_
...
- LAVA[^10] and the group-LAVA variants for the all the group-sparse methods
- Ridge Regression[^11]

For all these regularizers, **Quadrupen** offers the possibility to add an
$\ell_2$/ridge-like "structured" penalty to embed some external knowledge about
the statistical dependence between the features. This is sometimes referred to as the "Structured Elastic-Net"[^7].
...
Many examples and demos can be found in the `inst` directory.  Here is a more illustrative one:
