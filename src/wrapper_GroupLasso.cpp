...
List group_enet_l1l2_dense_cpp(
  ...
  GroupElasticNet<mat,MixedNorm::L1L2> grpenet(data, group, regParam, control);
...
List group_enet_l1l2_sparse_cpp(
  ...
  GroupElasticNet<sp_mat,MixedNorm::L1L2> grpenet(data, group, regParam, control);
...
List group_enet_l1linf_sparse_cpp(
  ...
  GroupElasticNet<sp_mat,MixedNorm::L1LINF> grpenet(data, group, regParam, control);
