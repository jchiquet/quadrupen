...
public:
  ...
  // Helper: Clear all sub-nodes vectors for a given node set
  void clearSubNodesICG(const list<int>& nodeList);
  void clearSubNodesCWSM(const list<int>& nodeList);
  void clearSubNodesCT(const list<int>& nodeList);
