...
List group_lava_l1l2_dense_cpp(
  ...
  GroupLava<mat,GroupSparseNorm::L1L2> group_lava(scaled_data, Proj, group, regParam, control);
...
List group_lava_l1linf_dense_cpp(
  ...
  GroupLava<mat,GroupSparseNorm::L1LINF> group_lava(scaled_data, Proj, group, regParam, control);
...
List group_lava_coop_dense_cpp(
  ...
  GroupLava<mat,GroupSparseNorm::COOP> group_lava(scaled_data, Proj, group, regParam, control);
