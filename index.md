...
#### Ridge regression ($\ell_{2}$ penalty)
...
#### Elastic-net ($\ell_{1} + \ell_{2}$ penalty)
...
#### Ridge + Bounded regression ($\ell_{\infty} + \ell_{2}$ penalty)
...
#### Structured/Generalized Ridge regression ($\ell_{2}$ penalty)
...
#### Structured/Generalized Elastic-net ($\ell_{1} + \ell_{2}$ penalty)
...
#### Bounded regression + structured/Generalized Ridge ($\ell_{\infty} + \ell_{2}$ penalty)
...
($\ell_{1}/\ell_{2}$ mixed norm), type 2 group Lasso (
($\ell_{1}/\ell_{\infty}$ mixed norm)) and the
...
![](reference/figures/grplasso-l1l2-1.png)
...
![](reference/figures/grplasso-l1linf-1.png)
...
![](reference/figures/cooplasso-1.png)

### Regularization mixing smooth and hard prior knowledge

We let the possibility to add structured-$\ell_{2}$ penalty to this
...
![](reference/figures/grpenet-l1l2-1.png)
...
![](reference/figures/grpenet-l1linf-1.png)
...
![](reference/figures/coopenet-1.png)
